...
export const ES: TranslationDict = {
  ...
  landing: {
    ...
    // Bootcamp Card
    bootcampCard: {
      nextEdition: 'PRÓXIMA EDICIÓN - ENERO 2025',
      title: 'Bootcamp Fundamentos de Data Engineering',
      description: '8 semanas intensivas en vivo. Desde cero hasta tu primer proyecto profesional.',
...
export const EN: TranslationDict = {
  ...
  landing: {
    ...
    // Bootcamp Card
    bootcampCard: {
      nextEdition: 'NEXT EDITION - JANUARY 2025',
      title: 'Data Engineering Fundamentals Bootcamp',
      description: '8 intensive weeks live. From zero to your first professional project.',
...
export const PT: TranslationDict = {
  ...
  landing: {
    ...
    // Bootcamp Card
    bootcampCard: {
      nextEdition: 'PRÓXIMA EDIÇÃO - JANEIRO 2025',
      title: 'Bootcamp Fundamentos de Data Engineering',
      description: '8 semanas intensivas ao vivo. Do zero ao seu primeiro projeto profissional.',
